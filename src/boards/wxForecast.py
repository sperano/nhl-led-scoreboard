...
class wxForecast:
    def __init__(self, data, matrix,sleepEvent):
        ...
        self.wxfont_wide = data.config.layout.wxfont_wide
            ...
            while show_day < self.data.config.weather_forecast_days and not self.sleepEvent.is_set():
                ...
                if len(self.data.wx_forecast) > 0:
                    ...
                    if self.matrix.width == 32:
                        ...
                        summary_info = self.matrix.draw_text(["1%", "77%"],self.data.wx_forecast[show_day][1],self.wxfont_wide)
        ...
        while x < display_loop and not self.sleepEvent.is_set():
            ...
            if not self.scroll_summary:
                ...
                if self.matrix.width == 32:
                    ...
                    self.matrix.draw_text([pos,"67%"],self.data.wx_forecast[forecast_day][1],self.wxfont_wide)
